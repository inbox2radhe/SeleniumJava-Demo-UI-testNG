...
public class LoginPage extends BaseClass {
	...
	public void loginFuction_DMT1(int row,String env) throws IOException, InterruptedException {
		...
		try {
			launchURL(ExcelUtils.excelreadURL1(env));
...
//	
	...
	/*
	 * //Change to Pickup to Shipping option public void
	 * change_PickupToShipping_Flow(int row) throws IOException,
	 * InterruptedException { String path = System.getProperty("user.dir"); String
	 ...
	 * PageFactory.initElements(driver, or);
	 * 
	 * //calling loginIntoMagento() generic method clickelement(or.loginlink);
	 * clickelement(or.loginbutton); loginIntoMagento();
	 * 
	 * //calling addProductTocart() generic method String productName =
	 * tocSheet.getRow(row).getCell(3).getStringCellValue();
	 * addProductTocart(productName);
	 * 
	 * //Clicking on Proceed To Checkout option clickelement(or.proceedtocheckout);
	 * String deliveryOption = tocSheet.getRow(row).getCell(5).getStringCellValue();
	 * 
	 * System.out.println("Delivery type is"+deliveryOption); waitSync(); if
	 * (deliveryOption.equalsIgnoreCase("Pickup")) {
	 * System.out.println("Printing inside Pickup IF contion"); waitSync();
	 * 
	 * clickelement(or.pickupstore_selectionbutton);
	 * System.out.println("PickUp option selected"); waitSync();
	 * clickelement(or.changeToShipping); } //Shipping details code
	 * inputtext(or.shippingaddress_fname, "Joe");
	 * inputtext(or.shippingaddress_lname, "Doe");
	 * inputtext(or.shippingaddress_email, "email@email.com");
	 * inputtext(or.shippingaddress_company, "FedEx");
	 * inputtext(or.shippingaddress_address, "7900 Legacy Dr");
	 * inputtext(or.shippingaddress_city, "Plano"); Select drpState = new
	 ...
	 * tocSheet.getRow(row).getCell(7).getStringCellValue(); //String
	 ...
	 * System.out.println("Printing from cc flow");
	 * clickelement(or.cc_reviewbutton); //cc_revieworder_Prod } else {
	 * 
	 * System.out.println("Printing from FedEx Acc flow");
	 ...
	 * clickelement(or.fedexacc_revieworder);// clicking prod order review button
	 * 
	 * } clickelement(or.terms_condition_checkbox); waitSync();
	 * clickelement(or.submitorder_button); waitSync();
	 * expwaitVisibility(or.ordergtn); waitSync();
	 * System.out.println(or.ordergtn.getText());
	 * 
	 * 
	 * 
	...
	/*
	 * //Change to Shipping to Pickup public void change_ShippingToPickup_Flow(int
	 * row) throws IOException, InterruptedException { String path =
	 * System.getProperty("user.dir"); String testDataSheetPath = (path +
	 * "\\src\\main\\java\\com\\NonKeyword_FutureReadyFramework\\automation\\data\\TestData.xlsx"
	 * );
	 * 
	 * List<String> list = new ArrayList<String>(); File f = new
	 ...
	 * 
	 * System.out.println("Delivery type is"+deliveryOption); waitSync(); if
	 * (deliveryOption.equalsIgnoreCase("Shipping")) {
	 * System.out.println("Printing inside Shipping IF contion"); waitSync();
	 * 
	 * clickelement(or.shiptoaddress_selectionbutton);
	 * System.out.println("Shipping option selected"); waitSync();
	 * clickelement(or.changeToPickup); } //Pickup flow
	 * System.out.println("PickUp option selected");
	 ...
	 * "email@email.com"); clickelement(or.alternatepickupperson_checkbox);
	 ...
	 * year.selectByVisibleText("2026"); inputtext(or.cvv,"111");
	 * 
	 * //Billing info System.out.println("Printing from cc flow1");
	 * inputtext(or.billingadd_companyname, "FedEx");
	 * inputtext(or.billingadd_adress, "7900 Legacy Dr");
	 * inputtext(or.billingadd_adressline2, "Suite 300");
	 * inputtext(or.billingadd_city, "Plano");
	 ...
	 * "75024"); System.out.println("Printing from cc flow2"); waitSync();
	 * windowScroll(); expwaitClickable(or.cc_reviewbutton); waitSync();
	 * System.out.println("Printing from cc flow");
	 * clickelement(or.cc_reviewbutton); //cc_revieworder_Prod
	 * 
	 * 
