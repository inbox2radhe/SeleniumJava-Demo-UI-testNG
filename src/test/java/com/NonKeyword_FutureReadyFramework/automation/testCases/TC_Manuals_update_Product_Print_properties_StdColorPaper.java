...
public class TC_Manuals_update_Product_Print_properties_StdColorPaper {
	
	@Test(enabled=true)
	public void TC67_Manuals_update_Product_Print_properties_StdColorPaper() throws IOException, InterruptedException {
		...
		pc.Manuals_update_Product_Print_properties_StdColorPaper(rowNumber);
	}
