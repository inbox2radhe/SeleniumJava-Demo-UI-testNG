...
public class TC_NoteCards_QuickLinks_pickUP_CCFlow extends BaseClass{
	
	@Test(enabled = true)
	public void TC50_NoteCards_QuickLinks_pickUP_CCFlow() throws IOException, InterruptedException {
