...
public class TC_Manuals_update_Product_Print_properties_ProWhitePaper {
	
	@Test(enabled=true)
	public void TC65_Manuals_update_Product_Print_properties_ProWhitePaper() throws IOException, InterruptedException {
		...
		pc.Manuals_update_Product_Print_properties_ProWhitePaper(rowNumber);
	}
