...
public class TC_Manuals_update_Product_Print_properties_AdvOptions_BlankSheets {
	
	
	@Test(enabled=true)
	public void TC75_Manuals_update_Product_Print_properties_AdvOptions_BlankSheets() throws IOException, InterruptedException {
		...
		pc.Manuals_update_Product_Print_properties_AdvOptions_BlankSheets(rowNumber);
