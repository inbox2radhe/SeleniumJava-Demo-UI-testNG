...
public class TC_Manuals_update_Product_Print_properties_StdWhitePaper {
	
	@Test(enabled = true)
	public void TC64_TC_Manuals_update_Product_Print_properties_StdWhitePaper() throws Exception {
		...
		pc.Manuals_update_Product_Print_properties_StdWhitePaper(rowNumber);
	}
