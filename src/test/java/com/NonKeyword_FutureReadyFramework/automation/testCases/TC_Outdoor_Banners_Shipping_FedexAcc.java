...
public class TC_Outdoor_Banners_Shipping_FedexAcc extends BaseClass{
	
	@Test(enabled = true)
	public void TC44_Outdoor_Banners_Shipping_FedexAcc() throws IOException, InterruptedException {
		...
		loginPage.OutDoor_Banners_Flow(rowNumber);
	}
