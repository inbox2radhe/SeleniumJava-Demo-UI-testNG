...
public class TC_Delete_and_Clear_Cart_Flow extends BaseClass{
	
	@Test(enabled = true)
	public void TC54_Delete_and_Clear_Cart_Flow() throws IOException, InterruptedException {
		...
		loginPage.delete_and_clear_cart();
