...
public class TC_checkoutUsing_MiniCart_Pickup_CC extends BaseClass{
	
	@Test(enabled = true)
	public void TC58_checkoutUsing_MiniCart_Pickup_CC() throws IOException, InterruptedException {
