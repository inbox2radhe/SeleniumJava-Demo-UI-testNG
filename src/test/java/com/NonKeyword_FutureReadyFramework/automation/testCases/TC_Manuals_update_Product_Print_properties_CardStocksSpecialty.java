...
public class TC_Manuals_update_Product_Print_properties_CardStocksSpecialty {
	
	@Test(enabled=true)
	public void TC66_Manuals_update_Product_Print_properties_CardStocksSpecialty() throws IOException, InterruptedException {
		...
		pc.Manuals_update_Product_Print_properties_CardStocksSpecialty(rowNumber);
