...
public class TC_Manuals_update_Product_Print_properties_Orientation {
	
	@Test(enabled=true)
	public void TC71_Manuals_update_Product_Print_properties_Orientation() throws IOException, Exception {
		...
		pc.Manuals_update_Product_Print_properties_Sides(rowNumber);
