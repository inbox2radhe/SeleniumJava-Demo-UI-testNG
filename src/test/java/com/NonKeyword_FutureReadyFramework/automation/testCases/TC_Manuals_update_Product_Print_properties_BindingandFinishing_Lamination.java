...
public class TC_Manuals_update_Product_Print_properties_BindingandFinishing_Lamination {
	
	@Test(enabled=true)
	public void TC74_Manuals_update_Product_Print_properties_BindingandFinishing_Lamination() throws IOException, InterruptedException {
		...
		pc.Manuals_update_Product_Print_properties_BindingandFinishing_Lamination(rowNumber);
