...
public class TC_Outdoor_Banners_PickUp_FedexAcc extends BaseClass{
	
	@Test(enabled = true)
	public void TC46_Outdoor_Banners_PickUp_FedexAcc() throws IOException, InterruptedException {
