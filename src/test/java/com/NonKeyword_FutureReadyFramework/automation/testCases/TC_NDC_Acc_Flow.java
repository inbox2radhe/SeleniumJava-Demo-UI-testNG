...
public class TC_NDC_Acc_Flow extends BaseClass{

	
	
	@Test(enabled = true)
	public void TC51_NDC_Acc_Flow() throws IOException, InterruptedException {
		...
		loginPage.NDC_Account_Flow(rowNumber);
