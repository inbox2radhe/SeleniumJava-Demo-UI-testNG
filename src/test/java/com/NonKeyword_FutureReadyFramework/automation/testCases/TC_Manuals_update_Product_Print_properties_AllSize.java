...
public class TC_Manuals_update_Product_Print_properties_AllSize {
	
	@Test(enabled = true)
	public void TC63_Manuals_update_Product_Print_properties_AllSize() throws Exception {
		...
		pc.Manuals_update_Product_Print_properties_AllSize(rowNumber);
	}	
