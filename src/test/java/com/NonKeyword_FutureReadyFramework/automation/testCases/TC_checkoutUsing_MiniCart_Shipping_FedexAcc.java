...
public class TC_checkoutUsing_MiniCart_Shipping_FedexAcc extends BaseClass{
	
	
	@Test(enabled = true)
	public void TC57_checkoutUsing_MiniCart_Shipping_FedexAcc() throws IOException, InterruptedException {
		...
		loginPage.MiniCartFlow(rowNumber);
	}
