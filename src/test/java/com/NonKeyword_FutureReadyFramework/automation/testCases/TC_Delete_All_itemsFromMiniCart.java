...
public class TC_Delete_All_itemsFromMiniCart extends BaseClass{
	
	
	@Test(enabled = true)
	public void TC55_Delete_All_itemsFromMiniCart() throws IOException, InterruptedException {
		...
		loginPage.MiniCart_delete_and_clear_cart(rowNumber);
